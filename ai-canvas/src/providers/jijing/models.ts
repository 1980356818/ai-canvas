...
//   seedance-2-0      → V138 alias: 后端 model_route 2223/2224/2225/2226 (Nexus 1095, 4 个上游).
//                       VideoEditor 按 (分辨率 720P/1080P, 是否传参考视频) resolve 到具体 model_name,
//                       见 resolveSeedanceVipModelId + VideoEditor.handleGenerate.
//   seedance-2-0-720p-15s-no-person  → V138 经济版独立项 (后端 model_route 2222, sd-2-vip 上游),
