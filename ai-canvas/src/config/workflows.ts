      ...
      },
      {
        ...
        data: {
          ...
          _systemPrompt: [
            ...
            "",
            "套用模板生成提示词：",
            "基于识别到的信息，按照以下格式生成标准化精修提示词，确保包含：",
            "- 服装提取与3D转换（如需）",
            "- 纯白背景与正面视图、背面视图的平视角",
            "- 领标、颜色、纹理、质感的精准还原",
            "- 多余褶皱去除与轮廓优化",
      ...
      },
      {
        ...
        data: {
          ...
          _systemPrompt: [
            ...
            "- 版型细节：阔腿版型、宽松版型等",
            "",
            "套用模板生成提示词，把识别到的信息填入标准化模板，确保包含：",
            "- 基于原图，保持所有细节不变",
            "- 生成一组8张多角度细节展示图，在2×4的网格里，采用16:9的比例展示不同的角度，不要有重复的角度呈现",
            "- 指定角度（正面、背面、45度角、关键部位特写）",
